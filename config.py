...
class Config:
    # API設定
    API_HOST = os.environ["API_URL"]
    SANDBOX_HOST = os.environ["SANDBOX_URL"]

    CHATFLOW_API_KEY = os.environ["CHATFLOW_API_KEY"]
    WORKFLOW_API_KEY = os.environ["WORKFLOW_API_KEY"]
    KNOWLEDGE_API_KEY = os.environ["WORKFLOW_API_KEY"]
